...
// 1. Revert main.py
let p = '/Users/nghiatrang/G-nome/G-Nome/backend/main.py';
...
// 2. Revert prs.py
p = '/Users/nghiatrang/G-nome/G-Nome/backend/prs.py';
code = fs.readFileSync(p, 'utf8');
code = code.replace("from .inference.risk_engine import predict_risk as predict_user_risk", "from inference.risk_engine import predict_risk as predict_user_risk");
fs.writeFileSync(p, code);

// 3. Revert rag.py
p = '/Users/nghiatrang/G-nome/G-Nome/backend/rag.py';
code = fs.readFileSync(p, 'utf8');
code = code.replace("from .supabase_client import get_supabase", "from supabase_client import get_supabase");
fs.writeFileSync(p, code);
